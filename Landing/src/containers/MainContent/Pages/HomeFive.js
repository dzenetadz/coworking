...
// Removed react-modal-video imports:
                ...
                <div className="container" id="containervideo">
                    <div className="row justify-content-center">
                        <div className="col-md-10 text-center text-white">
                            ...
                            {/* Removed the video modal trigger */}
                            {/* Removed: <span onClick={this.openModal} className="pt-4 video-play-icon watch-overview d-inline-block text-white">Watch the overview &nbsp;<i className="mdi mdi-chevron-right"></i></span> */}
                            <div className="">
